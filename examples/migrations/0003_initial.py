# Generated by Django 4.0.1 on 2022-01-10 07:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('examples', '0002_remove_product_artist_delete_artist_delete_product'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='artists', to=settings.AUTH_USER_MODEL)),
